...
## Project Structure
    ...
    ├── testapiautoteammemb_90952  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_90952`
...
2. Clone this repo and `cd testapiautoteammemb_90952`
